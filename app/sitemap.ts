...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/services/invisalign`,           lastModified, changeFrequency: 'monthly', priority: 0.95 },
    { url: `${base}/services/dental-emergencies`,   lastModified, changeFrequency: 'monthly', priority: 0.95 },
    { url: `${base}/services/periodontics`,         lastModified, changeFrequency: 'monthly', priority: 0.9 },
    { url: `${base}/services/teeth-whitening`,      lastModified, changeFrequency: 'monthly', priority: 0.85 },
    { url: `${base}/services/cleanings`,            lastModified, changeFrequency: 'monthly', priority: 0.85 },
